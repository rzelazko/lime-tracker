      ...
      subReports: [
        {
          ...
          cases: [
            { seizure: { occurred: moment('2021-12-24T14:24:00'), type: 'Type F', duration: moment.duration(460, 'seconds') } },
            { seizure: { occurred: moment('2021-12-22T14:24:00'), type: 'Type D', duration: moment.duration(300, 'seconds') } },
        ...
        },
        {
          ...
          cases: [
            { seizure: { occurred: moment('2021-10-10T14:24:00'), type: 'Type A', duration: moment.duration(240, 'seconds') } },
          ],
        },
        {
          ...
          cases: [
            { seizure: { occurred: moment('2021-09-30T11:24:00'), type: 'Type A', duration: moment.duration(460, 'seconds') } },
            { seizure: { occurred: moment('2021-09-27T19:24:00'), type: 'Type B', duration: moment.duration(300, 'seconds') } },
            { seizure: { occurred: moment('2021-09-17T19:24:00'), type: 'Type C', duration: moment.duration(260, 'seconds') } },
        ...
        },
        {
          ...
          cases: [
            { seizure: { occurred: moment('2021-08-22T19:24:00'), type: 'Type B', duration: moment.duration(300, 'seconds') } },
            { seizure: { occurred: moment('2021-08-12T19:24:00'), type: 'Type A', duration: moment.duration(180, 'seconds') } },
            { seizure: { occurred: moment('2021-08-02T19:24:00'), type: 'Type B', duration: moment.duration(300, 'seconds') } },
          ],
        },
        {
          ...
          cases: [
            { seizure: { occurred: moment('2021-07-31T19:24:00'), type: 'Type B', duration: moment.duration(300, 'seconds') } },
          ],
        },
        {
          ...
          cases: [
            ...
            { seizure: { occurred: moment('2021-06-28T19:24:00'), type: 'Type F', duration: moment.duration(460, 'seconds') } },
            { seizure: { occurred: moment('2021-06-20T19:24:00'), type: 'Type B', duration: moment.duration(300, 'seconds') } },
            { seizure: { occurred: moment('2021-06-19T19:24:00'), type: 'Type D', duration: moment.duration(240, 'seconds') } },
          ],
        },
      ],
    };
